...
- 크론이 시간당 6회(:07 :17 :27 :37 :47 :57) 발사되고, 사전 체크의 dedup 가드(최근 50분 내 이력 존재 시 스킵)가 실제 점검을 시간당 1회로 제한합니다. GitHub Actions 크론 트리거 누락에 대비한 중복 트리거 구조입니다.
- 평일 KST 01~07시는 건너뜁니다. 주말은 24시간 점검합니다.
